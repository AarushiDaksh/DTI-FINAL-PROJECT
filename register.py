...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Aarushi Daksh\Desktop\DTI_FINAL_PROJECT\Images_GUI\bgReg.jpg")
        ...
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            try:
                ...
                if row!=None:
                    ...
                    mycursor.execute("INSERT INTO regteach (first_name, last_name, contact_number, email, security_question, security_answer, password) VALUES (%s, %s, %s, %s, %s, %s, %s)", (
                    self.var_fname.get(),
                     self.var_lname.get(),
                     self.var_cnum.get(),
                     self.var_email.get(),
